# Benchmark: llama-3.1-8b ft-v1 quick (Colab)
...
- **Macro field accuracy:**  96.5%
- **Evidence grounding rate:**  99.6%

## Per-field

| field | n | cov | acc | prec | rec | F1 | set_F1 | vocab! | case! |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `amenities_interior` |  60 | 0.750 | 0.633 | 0.578 | 0.578 | 0.578 | 0.731 |   1 |   0 |
| `nearby_mentions` |  60 | 0.700 | 0.667 | 0.585 | 0.571 | 0.578 | 0.774 |   0 |   0 |
| `amenities_outdoor` |  60 | 0.667 | 0.883 | 0.895 | 0.850 | 0.872 | 0.872 |   0 |   0 |
| `amenities_appliances` |  60 | 0.267 | 0.883 | 0.733 | 0.688 | 0.710 | 0.659 |   0 |   0 |
| `rent.bills_included` |  60 | 0.383 | 0.900 | 0.870 | 0.870 | 0.870 |    —  |   0 |   0 |
| `room.shared_living_room` |  60 | 0.167 | 0.900 | 0.750 | 0.600 | 0.667 |    —  |   0 |   0 |
| `parking` |  60 | 0.417 | 0.917 | 0.875 | 0.840 | 0.857 | 0.808 |   1 |   0 |
| `rent.deposit_amount` |  60 | 0.167 | 0.917 | 0.778 | 0.700 | 0.737 |    —  |   0 |   0 |
| `amenities_facilities` |  60 | 0.100 | 0.933 | 0.400 | 0.333 | 0.364 | 0.763 |   0 |   0 |
| `rent.furnish_type` |  60 | 0.500 | 0.933 | 0.931 | 0.900 | 0.915 |    —  |   0 |   0 |
| `room.listing_for_number_of_rooms` |  60 | 0.067 | 0.933 | 0.500 | 0.750 | 0.600 |    —  |   0 |   0 |
| `room.desired_occupation` |  60 | 0.067 | 0.933 | 0.500 | 0.500 | 0.500 |    —  |   0 |   0 |
| `commute_claims` |  60 | 0.117 | 0.933 | 0.556 | 0.714 | 0.625 | 0.689 |   0 |   0 |
| `school_mentions` |  60 | 0.150 | 0.933 | 0.700 | 0.778 | 0.737 | 0.773 |   0 |   0 |
| `property_type` |  60 | 1.000 | 0.950 | 0.950 | 0.950 | 0.950 |    —  |   0 |   0 |
| `total_floors` |  60 | 0.083 | 0.950 | 0.750 | 0.600 | 0.667 |    —  |   0 |   0 |
| `floors_occupied` |  60 | 0.333 | 0.950 | 1.000 | 0.850 | 0.919 |    —  |   0 |   0 |
| `rent.deposit_weeks` |  60 | 0.083 | 0.950 | 0.750 | 0.600 | 0.667 |    —  |   0 |   0 |
| `living_rooms` |  60 | 0.550 | 0.967 | 0.969 | 0.939 | 0.954 |    —  |   0 |   0 |
| `rent.let_type` |  60 | 0.133 | 0.967 | 0.778 | 0.875 | 0.824 |    —  |   0 |   0 |
| `rent.smokers_allowed` |  60 | 0.083 | 0.967 | 1.000 | 0.600 | 0.750 |    —  |   0 |   0 |
| `rent.rental_support_accepted` |  60 | 0.050 | 0.967 | 1.000 | 0.333 | 0.500 |    —  |   0 |   0 |
| `rent.student_friendly` |  60 | 0.133 | 0.967 | 0.875 | 0.875 | 0.875 |    —  |   0 |   0 |
| `room.current_number_of_flatmates` |  60 | 0.083 | 0.967 | 0.750 | 0.600 | 0.667 |    —  |   0 |   0 |
| `room.couples_allowed` |  60 | 0.067 | 0.967 | 0.750 | 0.750 | 0.750 |    —  |   0 |   0 |
| `flags.is_chain_free` |  60 | 0.050 | 0.967 | 0.667 | 0.667 | 0.667 |    —  |   0 |   0 |
| `flags.is_build_to_rent` |  60 | 0.033 | 0.967 | 0.500 | 0.500 | 0.500 |    —  |   0 |   0 |
| `flags.is_new_build` |  60 | 0.033 | 0.967 | 0.000 | 0.000 | 0.000 |    —  |   0 |   0 |
| `beds` |  60 | 0.700 | 0.983 | 0.977 | 1.000 | 0.988 |    —  |   0 |   0 |
| `baths` |  60 | 0.583 | 0.983 | 0.972 | 1.000 | 0.986 |    —  |   0 |   0 |
| `total_floor_area_sqm` |  60 | 0.067 | 0.983 | 0.800 | 1.000 | 0.889 |    —  |   0 |   0 |
| `rent.tenancy_min_months` |  60 | 0.067 | 0.983 | 1.000 | 0.750 | 0.857 |    —  |   0 |   0 |
| `rent.pets_allowed` |  60 | 0.100 | 0.983 | 1.000 | 0.833 | 0.909 |    —  |   0 |   0 |
| `rent.wifi_included` |  60 | 0.150 | 0.983 | 0.900 | 1.000 | 0.947 |    —  |   0 |   0 |
| `rent.dps` |  60 | 0.033 | 0.983 | 1.000 | 0.500 | 0.667 |    —  |   0 |   0 |
| `room.room_type` |  60 | 0.250 | 0.983 | 0.933 | 0.933 | 0.933 |    —  |   0 |   0 |
