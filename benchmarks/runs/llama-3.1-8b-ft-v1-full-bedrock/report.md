# Benchmark: llama-3.1-8b-ft-v1 (full, Bedrock)
...
- **Macro field accuracy:**  92.2%
- **Evidence grounding rate:**  96.7%

## Per-field

| field | n | cov | acc | prec | rec | F1 | set_F1 | vocab! | case! |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `amenities_interior` |  60 | 0.750 | 0.483 | 0.412 | 0.311 | 0.354 | 0.589 |   0 |   0 |
| `nearby_mentions` |  60 | 0.700 | 0.483 | 0.444 | 0.286 | 0.348 | 0.444 |   0 |   0 |
| `rent.let_type` |  60 | 0.133 | 0.650 | 0.250 | 0.875 | 0.389 |    —  |   0 |   0 |
| `rent.bills_included` |  60 | 0.383 | 0.667 | 0.526 | 0.870 | 0.656 |    —  |   0 |   0 |
| `rent.furnish_type` |  60 | 0.500 | 0.683 | 0.619 | 0.867 | 0.722 |    —  |   0 |   0 |
| `beds` |  60 | 0.700 | 0.733 | 0.719 | 0.976 | 0.828 |    —  |   0 |   0 |
| `baths` |  60 | 0.583 | 0.733 | 0.688 | 0.943 | 0.795 |    —  |   0 |   0 |
| `rent.dps` |  60 | 0.033 | 0.750 | 0.118 | 1.000 | 0.211 |    —  |   0 |   0 |
| `amenities_appliances` |  60 | 0.267 | 0.783 | 0.545 | 0.375 | 0.444 | 0.403 |   0 |   0 |
| `rent.pets_allowed` |  60 | 0.100 | 0.850 | 0.400 | 1.000 | 0.571 |    —  |   0 |   0 |
| `room.listing_for_number_of_rooms` |  60 | 0.067 | 0.850 | 0.308 | 1.000 | 0.471 |    —  |   0 |   0 |
| `commute_claims` |  60 | 0.117 | 0.850 | 0.333 | 0.571 | 0.421 | 0.400 |   0 |   0 |
| `amenities_outdoor` |  60 | 0.667 | 0.867 | 0.892 | 0.825 | 0.857 | 0.854 |   0 |   0 |
| `living_rooms` |  60 | 0.550 | 0.883 | 0.821 | 0.970 | 0.889 |    —  |   0 |   0 |
| `floors_occupied` |  60 | 0.333 | 0.900 | 0.783 | 0.900 | 0.837 |    —  |   0 |   0 |
| `rent.wifi_included` |  60 | 0.150 | 0.900 | 0.615 | 0.889 | 0.727 |    —  |   0 |   0 |
| `rent.student_friendly` |  60 | 0.133 | 0.900 | 0.583 | 0.875 | 0.700 |    —  |   0 |   0 |
| `property_type` |  60 | 1.000 | 0.917 | 0.948 | 0.917 | 0.932 |    —  |   0 |   0 |
| `rent.deposit_amount` |  60 | 0.167 | 0.917 | 0.727 | 0.800 | 0.762 |    —  |   0 |   0 |
| `room.desired_occupation` |  60 | 0.067 | 0.917 | 0.429 | 0.750 | 0.545 |    —  |   0 |   0 |
| `room.shared_living_room` |  60 | 0.167 | 0.917 | 0.778 | 0.700 | 0.737 |    —  |   0 |   0 |
| `flags.is_build_to_rent` |  60 | 0.033 | 0.917 | 0.000 | 0.000 | 0.000 |    —  |   0 |   0 |
| `parking` |  60 | 0.417 | 0.933 | 0.880 | 0.880 | 0.880 | 0.865 |   0 |   0 |
| `room.room_type` |  60 | 0.250 | 0.933 | 0.778 | 0.933 | 0.848 |    —  |   0 |   0 |
| `room.current_number_of_flatmates` |  60 | 0.083 | 0.933 | 0.400 | 0.400 | 0.400 |    —  |   0 |   0 |
| `school_mentions` |  60 | 0.150 | 0.933 | 1.000 | 0.556 | 0.714 | 0.556 |   0 |   0 |
| `total_floors` |  60 | 0.083 | 0.950 | 0.750 | 0.600 | 0.667 |    —  |   0 |   0 |
| `amenities_facilities` |  60 | 0.100 | 0.950 | 0.600 | 0.500 | 0.545 | 0.802 |   0 |   0 |
| `rent.deposit_weeks` |  60 | 0.083 | 0.950 | 1.000 | 0.400 | 0.571 |    —  |   0 |   0 |
| `room.couples_allowed` |  60 | 0.067 | 0.950 | 0.571 | 1.000 | 0.727 |    —  |   0 |   0 |
| `total_floor_area_sqm` |  60 | 0.067 | 0.967 | 0.667 | 1.000 | 0.800 |    —  |   0 |   0 |
| `build_year_min` |  60 | 0.017 | 0.967 | 0.333 | 1.000 | 0.500 |    —  |   0 |   0 |
| `build_year_max` |  60 | 0.017 | 0.967 | 0.333 | 1.000 | 0.500 |    —  |   0 |   0 |
| `window_orientation` |  60 | 0.033 | 0.967 | 0.500 | 1.000 | 0.667 |    —  |   0 |   0 |
| `sale.tenure_type` |  60 | 0.050 | 0.967 | 0.600 | 1.000 | 0.750 |    —  |   0 |   0 |
| `room.current_occupation` |  60 | 0.017 | 0.967 | 0.333 | 1.000 | 0.500 |    —  |   0 |   0 |
| `room.current_pets` |  60 | 0.017 | 0.967 | 0.333 | 1.000 | 0.500 |    —  |   0 |   0 |
| `flags.is_new_build` |  60 | 0.033 | 0.967 | 0.000 | 0.000 | 0.000 |    —  |   0 |   0 |
| `rent.tenancy_max_months` |  60 | 0.017 | 0.983 | 0.500 | 1.000 | 0.667 |    —  |   0 |   0 |
| `rent.rental_support_accepted` |  60 | 0.050 | 0.983 | 1.000 | 0.667 | 0.800 |    —  |   0 |   0 |
| `sale.ground_rent_amount` |  60 | 0.000 | 0.983 | 0.000 | 0.000 | 0.000 |    —  |   0 |   0 |
| `room.is_ensuite` |  60 | 0.083 | 0.983 | 0.833 | 1.000 | 0.909 |    —  |   0 |   0 |
| `room.current_gender` |  60 | 0.067 | 0.983 | 1.000 | 0.750 | 0.857 |    —  |   0 |   0 |
| `room.desired_age_min` |  60 | 0.017 | 0.983 | 0.000 | 0.000 | 0.000 |    —  |   0 |   0 |
| `room.desired_gender` |  60 | 0.000 | 0.983 | 0.000 | 0.000 | 0.000 |    —  |   0 |   0 |
